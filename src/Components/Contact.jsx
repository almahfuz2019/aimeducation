...
const Contact = () => {
     return (
          <div>
                 <div>
                 <h2 className="text-3xl font-bold text-primary tracki text-center sm:text-4xl mt-7 uppercase">
              Aliquip definiebas ad estsdfsdf
            </h2>
            <p className="max-w-3xl mx-auto  text-center ">
              Quando cetero his ne, eum admodum sapientem ut sdfsd.
            </p>
          </div>
