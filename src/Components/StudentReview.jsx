...
const StudentReview = () => {
     return (
          <div>
               <section className="bg-primary text-gray-100 my-2">
			...
			<div className="p-6 xl:col-span-3">
				<div className="grid gap-4 md:grid-cols-2">
					<div className="grid content-center gap-4">
						...
						<div className="p-6 rounded shadow-md bg-gray-100">
							<p className="text-gray-800">Sit wisi sapientem ut, pri civibus temporibus voluptatibus et, ius cu hinc fabulas. Nam meliore minimum et, regione convenire cum id. Ex pro eros mucius consectetuer, pro magna nulla nonumy ne, eam putent iudicabit consulatu cu.</p>
							<div className="flex items-center mt-4 space-x-4">
					...
					<div className="grid content-center gap-4">
						...
						<div className="p-6 rounded shadow-md bg-gray-100">
							...
							<div className="flex items-center mt-4 space-x-4">
								...
								<div>
									<p className="text-lg font-semibold text-primary">Leroy Jenkins</p>
									<p className="text-sm text-primary">CTO of Company Co.</p>
								</div>
							</div>
						</div>
					</div>
