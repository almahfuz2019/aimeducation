...
const SocialLogin = () => {
  ...
  return (
    <div>
      <button
        className="flex w-full items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100 border border-primary border-opacity-30"
